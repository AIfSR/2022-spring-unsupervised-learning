...
from AIfSR_Trajectory_Analysis.datasets.MultiLabelSyntheticDataset import MultiLabelSyntheticDataset
...
class MultiLabelSyntheticMSDFeatures(DatasetFeaturesBase):
    """This class provides easy access for all of the MSD values from the
    Synthetic dataset"""

    def __init__(self):
        dataset = MultiLabelSyntheticDataset()
        ...
        self._dataFileName = "multidata.pkl"
        self._labelFileName = "multilabel.pkl"
